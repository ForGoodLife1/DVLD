namespace DVLD.Data.AppMetaData
{
    public static class Router
    {
        ...
        {
            public const string Prefix = Rule + "Application";
        ...
        public static class PersontRouting
        {
            public const string Prefix = Rule + "Person";
            public const string GetByID = Prefix + "/Id";
            public const string GetDepartmentStudentsCount = Prefix + "/Person-Application-Count";
            public const string GetDepartmentStudentsCountById = Prefix + "/Person-Application-Count-ById/{id}";
