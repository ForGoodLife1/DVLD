...
namespace DVLD.Service.Implementations
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<JwtAuthResponse> GetJWTToken(IdUser idUser)
        {
        ...
        public async Task<JwtAuthResponse> GetRefreshToken(IdUser idUser, JwtSecurityToken jwtToken, DateTime? expiryDate, string refreshToken)
        {
