...
namespace DVLD.Service.Implementations
{
    ...
    public class AuthorizationService : IAuthorizationService
    {
        ...
        private readonly DvldContext _dbContext;
        #endregion
        #region Constructors
        public AuthorizationService(RoleManager<Role> roleManager,
                                    UserManager<IdUser> userManager,
                                    DvldContext dbContext)
        {
        ...
        public async Task<ManageUserRolesResponse> ManageUserRolesData(IdUser idUser)
        {
        ...
        public async Task<ManageUserClaimsResponse> ManageUserClaimData(IdUser idUser)
        {
